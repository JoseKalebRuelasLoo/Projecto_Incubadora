...
<head>
	...
	<script src="AltaAdmin.js"></script>
</head>

<body>
	<div class="container">
		<header class="hijos">
			<h1 id='titulo'>Alta Administradores</h1>
		</header>
		<?php
		session_start();
			...
			<table class="Tabla Tabla-Responsiva Tabla-Borde Tabla-Zebra Tabla-80">
				<thead>
					<tr>
						...
						<th class="txt-center" scope="col">Apellidos</th>
						<th class="txt-center" scope="col">Correo</th>
						<th class="txt-center" scope="col">Contraseña</th>
