...
<head>
    ...
    <script src="ComuDistri.js"></script>
</head>

<body>
    <div class="container">
        <header class="hijos">
            <h1 id='titulo'>Contactar Distribuidores</h1>
        </header>
        <?php
        session_start();
        ...
        ?>
        <section class="hijos">
            <h2>Distribuidores Disponibles</h2>
            <table class="Tabla Tabla-Responsiva Tabla-Borde Tabla-Zebra Tabla-50">
                <thead>
                    <tr>
                        <th class="txt-center" scope="col">Nombre</th>
                        <th class="txt-center" scope="col">Telefono</th>
                        <th class="txt-center" scope="col">Domicilio</th>
                    </tr>
                </thead>
                <tbody id="contenedor">
